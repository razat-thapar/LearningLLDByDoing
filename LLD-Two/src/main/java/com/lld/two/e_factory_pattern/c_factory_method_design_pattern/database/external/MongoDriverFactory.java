...
public class MongoDriverFactory implements DatabaseDriverFactory {
    @Override
    public DatabaseDriver createDatabase() {
        return new com.lld.two.e_factory_pattern.c_factory_method_design_pattern.database.external.MongoDriver();
    }
}
