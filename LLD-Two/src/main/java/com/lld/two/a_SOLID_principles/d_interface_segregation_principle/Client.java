...
//            Eagle eagle = new Eagle("rocket");
            ...
            //Fix 3: Create "Flyable" , "Danceable" , etc. interfaces based on behaviors.
                ...
                //2. Subtyping works. ( No Violation of LISKOV's Substitution Principle. )
                //3. Bird classes need to implement the behaviors due to abstraction.
                //4. Bird class hold only common behaviors shared by all birds.

                //CONS: NONE.
            System.out.println("###################Coding to an interface############################");
            List<Flyable> flyingbirds = List.of(new Sparrow("Twitty"),new Eagle("Rocket"));
            for(Flyable b : flyingbirds){
                b.fly();
            }
        ...
        //DEF:
            // Interfaces should be lightweight (less no of methods).
            // OR
            // SRP for interfaces.
        //Scenario 1: What if we had FlyableDanceable Interface as we observed that every flying birds also dance.
        //PROBLEM:
            // A bird like eagle that only flies would need modification in existing code base.
            // VIOLATION OF OCP as well as Interface Segregation Principle.
