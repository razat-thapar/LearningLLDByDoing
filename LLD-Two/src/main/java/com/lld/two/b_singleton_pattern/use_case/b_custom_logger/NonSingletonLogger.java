...
public class NonSingletonLogger implements Logger{
    //Part1 : Implement Singleton dp for Logger.
    private static NonSingletonLogger instance = null;
    private String logFilePath;
    private FileWriter fileWriter ;
    private boolean isClosed;
    private NonSingletonLogger(){
        this.isClosed = false;
    }
...
//        if(instance == null){
//            synchronized(NonSingletonLogger.class){
//                if(instance == null){
                    instance = new NonSingletonLogger();
//                    return instance;
//                }
//            }
//        }
