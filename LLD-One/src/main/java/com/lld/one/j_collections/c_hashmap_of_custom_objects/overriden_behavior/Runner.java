package com.lld.one.j_collections.c_hashmap_of_custom_objects.overriden_behavior;
...
class Runner {
    public static void main(String[] args) {
        ...
        List<Employee> employeeList = List.of(new Employee(1,"Razat"),new Employee(2,"John"),new Employee(1,"Aggarwal"),new Employee(3,"XYZ"));
