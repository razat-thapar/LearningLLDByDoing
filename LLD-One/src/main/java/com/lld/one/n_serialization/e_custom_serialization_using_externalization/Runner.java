...
import com.lld.one.n_serialization.CustomSerializationUtils;

import java.io.IOException;

public class Runner {
    public static void main(String[] args) throws IOException {
        CustomSerializationUtils customSerializationUtils = new CustomSerializationUtils();
        User user = User
                .builder()
                .id(1)
                .name("Razat")
        ...
        customSerializationUtils.serialize(user,fileFullPath);
        //try to deserialize it and print the object.
        User deserializedUser = customSerializationUtils.deserializeUser(fileFullPath);
